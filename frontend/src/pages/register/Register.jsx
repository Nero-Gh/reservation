...
const Register = () => {
  ...
  useEffect(() => {
    if (error) {
      toast.error("Incorrect username or password or email");
    }
  }, [error]);
                  ...
                  <div className="card-body p-4 p-lg-5 text-black">
                    <form>
                      <div className="d-flex align-items-center mb-3 pb-1">
                        <span className="h1 fw-bold mb-0">Book Me</span>
                      </div>
                      ...
                      <div class="mb-3">
                        ...
                        <input
                          ...
                          id="email"
                          onChange={handleChange}
                          placeholder="email: bismark@gmail.com"
                        />
                      </div>
                      <div class="mb-3">
                        <label for="username" class="form-label">
                          Country(case-sensitive)
                        </label>
                        <input
